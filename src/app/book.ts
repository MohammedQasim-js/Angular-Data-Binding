...
export class BookComponent {
  bookForm = new FormGroup({
    // name: new FormControl('Dr. Stone'),
    // writer: new FormControl('Riichiro Inagaki'),
    // price: new FormControl('299'),
    name: new FormControl('', [Validators.required, Validators.minLength(3)]),
    writer: new FormControl('', Validators.required),
    price: new FormControl('', Validators.required),
    image: new FormControl('', [Validators.required, ImageValidator.isValidxtension]),
  });
  ...
  // updateName() {
  //   this.name.setValue('Demon Slayer');
  // }
}
